...
class M_produk extends CI_Model {
    ...
    // Menyimpan data utama produk ke tb_produk
    public function insert_produk_utama($data) {
        $this->db->insert('tb_produk', $data);
        return $this->db->insert_id(); 
    }

    // Menyimpan detail gambar ke tb_produk_image
    ...
    // Mengambil data untuk list di Dashboard
    ...
    // Menghapus produk dan file fisiknya
