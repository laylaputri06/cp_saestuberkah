...
class M_auth extends CI_Model {
    ...
    // get_admin_by_username() -> Menggantikan cek_login() MD5 yang lama
    ...
    // log_attempt() -> Mencatat kegagalan (Dipanggil saat login gagal)
    ...
    // check_limit() -> Fungsi yang bermasalah (Dipanggil di awal login)
