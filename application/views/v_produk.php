...
<head>
    ...
    <style>
        :root { --primary-blue: #2005a2; --bg-body: #F8FAFC; --card-bg: #FFFFFF; --watermark-color: #1a0380; }
        ...
        .grid-custom-layout { display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: 280px 280px 280px; gap: 24px; margin-bottom: 40px; }
        ...
        .img-box { display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 15px rgba(0,0,0,0.03); flex-grow: 1; position: relative; overflow: hidden; width: 100%; height: 100%; }
        .img-box img { width: 100%; height: 100%; object-fit: cover; z-index: 1; }
        .gallery-card { height: 400px; }
        .watermark { position: absolute; top: 30px; left: 25px; z-index: 10; display: flex; align-items: center; gap: 8px; mix-blend-mode: multiply; }
        .watermark img { height: 28px !important; width: auto !important; object-fit: contain; }
        .watermark-text { color: var(--watermark-color); line-height: 1.1; font-weight: 800; font-size: 0.85rem; text-align: left; }
        @media (max-width: 991px) { .sidebar { position: relative; width: 100%; height: auto; } .content { margin-left: 0; width: 100%; padding: 20px; } .wrapper { flex-direction: column; } .grid-custom-layout { display: flex; flex-direction: column; gap: 20px; } .grid-custom-layout > div { height: 300px; } }
    </style>
</head>
...
<a href="<?= base_url() ?>" style="position: fixed; bottom: 30px; right: 30px; background: white; width: 50px; height: 50px; border-radius: 12px; 
display: flex; align-items: center; justify-content: center; box-shadow: 0 5px 15px rgba(0,0,0,0.2); color: var(--primary-blue); text-decoration: none; z-index: 9999;">
