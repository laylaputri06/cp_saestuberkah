...
<head>
    ...
    <style>
        :root { --primary-blue: #2005a2; --active-blue: #304FFE; --page-bg: #F5F7FA; --card-bg: #FFFFFF; --header-bg: #EEF8FF; --text-dark: #1F2937; --product-shadow: 0 5px 20px rgba(0,0,0,0.06); }
        ...
        .border-left-column { border-left: 1px solid #f0f0f0; }
                    ...
                    <div class="row">
                        <div class="col-md-6 pe-md-5">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="number" name="no_wa_1" class="form-control mb-0" placeholder="857xxxx" value="<?= isset($konfig->no_wa_1) ? (substr($konfig->no_wa_1, 0, 2) == '62' ? substr($konfig->no_wa_1, 2) : $konfig->no_wa_1) : '' ?>" required>
                            </div>

                            <label class="form-label">WhatsApp Admin 2 (Cadangan)</label>
                            <div class="input-group mb-2">
                                <span class="input-group-text">+62</span>
                                <input type="number" name="no_wa_2" class="form-control mb-0" placeholder="812xxxx" value="<?= isset($konfig->no_wa_2) ? (substr($konfig->no_wa_2, 0, 2) == '62' ? substr($konfig->no_wa_2, 2) : $konfig->no_wa_2) : '' ?>" required>
                            </div>
                        ...
                        <div class="col-md-6 ps-md-5 border-left-column">
                            <div class="section-header">
