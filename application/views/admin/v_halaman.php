...
<head>
    ...
    <style>
        :root { --primary-blue: #2005a2; --active-blue: #304FFE; --page-bg: #FFFFFF; --section-bg: #F0F8FF; --header-bg: #EEF8FF; --text-dark: #1F2937; --text-gold: #D4AF37; }
        ...
        /* CONTENT CARDS */
        .content-card { background-color: var(--section-bg); padding: 40px; margin-bottom: 30px; border-radius: 0; position: relative; }
        .edit-link { display: block; text-align: right; margin-top: 20px; color: #1a0380; font-weight: 700; text-decoration: none; font-size: 0.9rem; cursor: pointer; }
