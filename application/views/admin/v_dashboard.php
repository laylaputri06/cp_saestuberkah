...
<head>
    ...
    <style>
        :root { --primary-blue: #2005a2; --page-bg: #FFFFFF; --card-bg: #EEF8FF; --activity-bg: #D4E4FC; --text-dark: #1F2937; --strong-shadow: 0 10px 25px rgba(26, 3, 128, 0.12); }
        ...
        .custom-card { background-color: var(--card-bg); border-radius: 25px; padding: 30px; box-shadow: var(--strong-shadow); height: 100%; border: none; position: relative; overflow: hidden; }
        .welcome-section { display: flex; justify-content: space-between; align-items: center; padding: 10px 20px; }
        .welcome-img { height: 160px; object-fit: contain; }
        ...
        .icon-shirt { width: 45px; height: 45px; stroke: var(--text-dark); fill: none; stroke-width: 1.5; }
        .section-header { display: flex; align-items: center; gap: 10px; margin-bottom: 20px; font-weight: 700; font-size: 1.1rem; }
        .activity-item { background-color: var(--activity-bg); border-radius: 15px; padding: 15px 20px; margin-bottom: 15px; display: flex; align-items: center; gap: 15px; font-weight: 500; color: var(--text-dark); font-size: 0.95rem; }
        .check-circle { background-color: #22C55E; color: white; width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 14px; flex-shrink: 0; }
        .btn-riwayat { background-color: #240099; color: white; border: none; padding: 10px 25px; border-radius: 50px; font-weight: 600; font-size: 0.9rem; float: right; display: flex; align-items: center; gap: 8px; margin-top: 10px; }
        .activity-item { display: flex; align-items: center; background-color: #eef2ff; padding: 10px 15px; border-radius: 12px; margin-bottom: 10px; }
        .check-circle { background-color: #10b981; color: white; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 12px; flex-shrink: 0; }
    </style>
</head>
<body>
