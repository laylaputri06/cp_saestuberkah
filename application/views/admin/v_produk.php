        ...
        <div class="content-wrapper">
            ...
            <?php if(isset($is_dashboard) && $is_dashboard == true): ?>
                <div class="d-flex justify-content-between align-items-center mb-3 mt-4">
                    <h5 class="fw-bold mb-0">Kemeja dan PDH</h5>
                    <a href="<?= base_url('admin/produk/kemeja_dan_PDH') ?>" class="btn btn-sm btn-outline-primary px-3 btn-rounded">Lihat Lainnya</a>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold mb-0">Kaos Polo</h5>
                    <a href="<?= base_url('admin/produk/kaos_polo') ?>" class="btn btn-sm btn-outline-primary px-3 btn-rounded">Lihat Lainnya</a>
                </div>
                <div class="row row-cols-2 row-cols-md-5 g-3 mb-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold mb-0">Kaos Polos</h5>
                    <a href="<?= base_url('admin/produk/kaos_polos') ?>" class="btn btn-sm btn-outline-primary px-3 btn-rounded">Lihat Lainnya</a>
                </div>
                <div class="row row-cols-2 row-cols-md-5 g-3 mb-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold mb-0">Rompi</h5>
                    <a href="<?= base_url('admin/produk/rompi') ?>" class="btn btn-sm btn-outline-primary px-3 btn-rounded">Lihat Lainnya</a>
                </div>
                <div class="row row-cols-2 row-cols-md-5 g-3 mb-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold mb-0">Galeri Pelanggan</h5>
                    <a href="<?= base_url('admin/produk/galeri') ?>" class="btn btn-sm btn-outline-primary px-3 btn-rounded">Lihat Lainnya</a>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-body pt-5 pb-5">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <button type="button" class="btn-batal" data-bs-dismiss="modal">Batal</button>
                        <a href="#" id="btn-confirm-delete" class="btn btn-danger py-2 px-4 btn-rounded fw-bold">Ya, Hapus</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/update_produk') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-5">
                                <div id="preview-edit-container" class="upload-area upload-preview-card">
                                    <img id="img-edit-preview" src="" alt="Preview">
                                </div>
                                <input type="file" name="foto_produk" id="file-edit-input" class="d-none" accept="image/*">
