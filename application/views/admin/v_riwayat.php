...
<head>
    ...
    <style>
        :root { --primary-blue: #2005a2; --page-bg: #FFFFFF; --card-bg: #EEF8FF; --header-table-bg: #CFD8EF; --text-dark: #1F2937; --strong-shadow: 0 10px 25px rgba(26, 3, 128, 0.12); }
        ...
        .nav-link.parent-active { color: #FFFFFF !important; font-weight: 700; }
        ...
        .section-title { font-weight: 800; font-size: 2rem; margin-bottom: 30px; color: #000; }
        .header-section { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; }
        .status-cell { padding-left: 30px; }
        
        /* TABEL STYLE */
        .table-custom { width: 100%; border-collapse: separate; border-spacing: 0; border: 1px solid #000; border-radius: 8px; overflow: hidden; }
        .table-custom th, .table-custom td { padding: 12px 20px; border-bottom: 1px solid #000; border-right: 1px solid #000; font-size: 0.95rem; color: #000; }
        .table-custom th:last-child, .table-custom td:last-child { border-right: none; }
        .table-custom tr:last-child td { border-bottom: none; }
        .table-custom thead { background-color: var(--header-table-bg); }
        .table-custom th { font-weight: 700; text-align: center; }
        .table-custom tbody tr { background-color: #fff; }
        .table-custom td { vertical-align: middle; }
        
        /* TOMBOL BAWAH */
        .btn-download { background-color: #240099; color: white; padding: 12px 25px; border-radius: 30px; font-weight: 700; text-decoration: none; display: inline-flex; align-items: center; gap: 10px; border: none; box-shadow: 0 4px 10px rgba(0,0,0,0.2); }
        .btn-download:hover { background-color: #1a0380; color: white; }
        .btn-tutup { background-color: white; color: black; padding: 10px 25px; border-radius: 40px; font-weight: 700; text-decoration: none; border: 1px solid #000; display: inline-flex; align-items: center; }
        .btn-tutup:hover { background-color: #f0f0f0; }
        .action-buttons { display: flex; gap: 20px; margin-top: 30px; align-items: center; }
    </style>
</head>
<body>
