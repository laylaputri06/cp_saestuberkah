...
class Admin extends CI_Controller {
    ...
    public function produk($kategori = null) 
    {
        ...
        if ($kategori === null) {
            ...
            $data['preview_galeri'] = $this->M_produk->get_produk_limit('galeri', 4); 
    ...
    public function save_produk() {
        ...
        $nomor_file = $this->input->post('nomor_file'); 
        ...
        // Simpan data utama ke tb_produk
        $data_induk = [
            'kategori'   => $kategori,
            'status'     => 'aktif',
    ...
    {
        // Ambil data produk sebelum dihapus untuk keperluan riwayat
    ...
    public function update_produk()
    {
        ...
        // Ambil data lama untuk keperluan hapus file fisik jika foto diganti
        $old_image = $this->db->get_where('tb_produk_image', ['produk_id' => $id])->row_array();

        // Update Kategori di tabel induk
        $this->db->where('id', $id);
   ...
   public function layanan()
    {
        ...
        // MENGAMBIL DATA DARI DATABASE (ID 1 sesuai baris yang dibuat di SQL)
    ...
    public function update_layanan() 
    {
        ...
        // Eksekusi update ke baris ID 1
        $this->db->where('id', 1);
        $this->db->update('tb_konfigurasi', $data_update);

        // Catat aktivitas dan beri notifikasi
